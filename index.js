...
const displayStr = `
So far, $${totalRaised.toLocaleString('en-US')} has been pledged across ${GAMES_JSON.length} games.
At the moment, ${numUnfundedGames === 1 ? "A game is still unfunded" : `${numUnfundedGames} games are still unfunded`}.
Help us bring these projects to life!
`;
